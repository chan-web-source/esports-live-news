  ...
  return (
    <div className={styles.headerContainer}>
      ...
      <div className={`${commonStyles.container} ${commonStyles.collapsableContainer} 
        ...
        {/* home team */}
        <div className={styles.teamLabel}>{t('matchDetail.homeTeam')}</div>
        <div key={matchStats?.homeTeam?.id} className={styles.matchContent}>
          <div className={styles.matchInfo}>
            <div>
              ...
              <span className={styles.tipCount}>21 {t('common.tips')}</span>
            </div>
          </div>
        ...
        {/* away team */}
        <div className={styles.teamLabel}>{t('matchDetail.awayTeam')}</div>
        <div key={matchStats?.homeTeam?.id} className={styles.matchContent}>
          <div className={styles.matchInfo}>
            <div>
              <span className={styles.matchTime}>07:00</span>
              <span className={styles.matchStatus}> {t('common.finished')}</span>
              <span className={styles.tipCount}>21 {t('common.tips')}</span>
            </div>
